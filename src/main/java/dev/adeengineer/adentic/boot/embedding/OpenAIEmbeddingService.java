package dev.adeengineer.adentic.boot.embedding;
...
import dev.adeengineer.rag.embedding.valueobject.Embedding;
import dev.adeengineer.rag.embedding.valueobject.EmbeddingRequest;
import java.net.URI;
