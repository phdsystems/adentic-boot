...
import dev.engineeringlab.adentic.agent.coordination.InMemoryMessageBus;
import dev.engineeringlab.adentic.boot.embedding.OpenAIEmbeddingService;
import dev.engineeringlab.adentic.provider.memory.InMemoryMemoryProvider;
import dev.engineeringlab.adentic.provider.orchestration.SimpleOrchestrationProvider;
import dev.engineeringlab.adentic.provider.queue.InMemoryTaskQueueProvider;
import dev.engineeringlab.adentic.provider.tools.MavenToolProvider;
import dev.engineeringlab.adentic.provider.tools.SimpleToolProvider;
import dev.engineeringlab.adentic.storage.local.LocalStorageProvider;
import dev.engineeringlab.adentic.tool.config.MavenToolConfig;
